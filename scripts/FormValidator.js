// export default
 class FormValidator{
    constructor(validationForm ,formElement) {
        ...
        this._inputList = Array.from(this._formElement.querySelectorAll(this._validationForm.inputSelector));
        this._buttonElement = this._formElement.querySelector(this._validationForm.submitButtonSelector);
...
_toggleButtonState() {
    if (this._hasInvalidInput()) {
        ...
        this._buttonElement.classList.add(this._validationForm.inactiveButtonClass)
    } else {
        this._buttonElement.removeAttribute('disabled');
        this._buttonElement.classList.remove(this._validationForm.inactiveButtonClass) 
    }
};
